...
function Movie() {
  ...
  useEffect(() => {
    // axios.get(`http://api.koreafilm.or.kr/openapi-data2/wisenut/search_api/search_json2.jsp?collection=kmdb_new2&detail=Y&ServiceKey=FPWJ81L14L7X38342790&releaseDts=20240520&ratedYn=y&releaseDte=20240719&listCount=500`)
    //   .then(res => {
