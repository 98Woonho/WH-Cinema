...
CREATE TABLE `payment` (
  ...
  KEY `user_id` (`user_id`),
  CONSTRAINT `payment_ibfk_1` FOREIGN KEY (`ticketing_id`) REFERENCES `ticketing` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `payment_ibfk_2` FOREIGN KEY (`user_id`) REFERENCES `user` (`user_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `screen_hall` VALUES (3,'1관','대구',30,15000,12000),(4,'2관','대구',30,17000,14000),(5,'4DX관','대구',20,19000,17000),(6,'3관','대구',30,15000,12000),(7,'4관','대구',30,15000,12000),(8,'5관','대구',30,15000,12000);
...
INSERT INTO `screen_info` VALUES (25,'07:40','2024-07-05',3,'인사이드 아웃'),(26,'07:40','2024-07-05',4,'인사이드 아웃'),(27,'07:40','2024-07-05',5,'인사이드 아웃'),(28,'07:40','2024-07-05',6,'인사이드 아웃'),(29,'07:40','2024-07-05',7,'인사이드 아웃'),(30,'07:40','2024-07-05',8,'인사이드 아웃');
...
INSERT INTO `theater` VALUES ('강남','서울'),('강릉','강원'),('강변','서울'),('거제','경상'),('건대입구','서울'),('계양','인천'),('고양백석','경기'),('고양행신','경기'),('광교','경기'),('광교상현','경기'),('광명역','경기'),('광주금남로','광주/전라/제주'),('광주상무','광주/전라/제주'),('광주용봉','광주/전라/제주'),('광주첨단','광주/전라/제주'),('광주충장로','광주/전라/제주'),('광주터미널','광주/전라/제주'),('광주하남','광주/전라/제주'),('구로','서울'),('구리','경기'),('구미','경상'),('기린','강원'),('기흥','경기'),('김천율곡','경상'),('김포','경기'),('김포운양','경기'),('김포한강','경기'),('김해','경상'),('김해율하','경상'),('김해장유','경상'),('논산','대전/충청'),('다산','경기'),('당진','대전/충청'),('대구','대구'),('대구수성','대구'),('대구스타디움','대구'),('대구아카데미','대구'),('대구연경','대구'),('대구월성','대구'),('대구죽전','대구'),('대연','부산/울산'),('대전','대전/충청'),('대전가수원','대전/충청'),('대전가오','대전/충청'),('대전탄방','대전/충청'),('대전터미널','대전/충청'),('대학로','서울'),('동대문','서울'),('동두천','경기'),('동래','부산/울산'),('동백','경기'),('동수원','경기'),('동탄','경기'),('동탄역','경기'),('동탄호수공원','경기'),('등촌','서울'),('마산','경상'),('명동','서울'),('미아','서울'),('방학','서울'),('배곧','경기'),('범계','경기'),('부산명지','부산/울산'),('부천','경기'),('부천역','경기'),('부천옥길','경기'),('부평','인천'),('북수원','경기'),('북포항','경상'),('불광','서울'),('산본','경기'),('상봉','서울'),('서면','부산/울산'),('서면삼정타워','부산/울산'),('서면상상마당','부산/울산'),('서산','대전/충청'),('서전주','광주/전라/제주'),('서현','경기'),('성신여대입구','서울'),('세종','대전/충청'),('센텀시티','부산/울산'),('소풍','경기'),('송파','서울'),('수유','서울'),('신세계경기','경기'),('아시아드','부산/울산'),('안동','경상'),('안산','경기'),('안성','경기'),('압구정','서울'),('양산삼호','경상'),('여의도','서울'),('연남','서울'),('연수역','인천'),('영등포','서울'),('왕십리','서울'),('용산','서울'),('울산동구','부산/울산'),('울산삼산','부산/울산'),('울산성남','부산/울산'),('울산신천','부산/울산'),('울산진장','부산/울산'),('원통','강원'),('유성노은','대전/충청'),('익산','광주/전라/제주'),('인천','인천'),('인천가정','인천'),('인천도화','인천'),('인천시민공원','인천'),('인천연수','인천'),('인천학익','인천'),('전주고사','광주/전라/제주'),('전주효자','광주/전라/제주'),('정읍','광주/전라/제주'),('제주','광주/전라/제주'),('제주노형','광주/전라/제주'),('주안역','인천'),('진주혁신','경상'),('창원','경상'),('창원더시티','경상'),('창원상남','경상'),('천안','대전/충청'),('천안시청','대전/충청'),('천안터미널','대전/충청'),('천안펜타포트','대전/충청'),('천호','서울'),('청담','서울'),('청주(서문)','대전/충청'),('청주율량','대전/충청'),('청주지웰시티','대전/충청'),('청주터미널','대전/충청'),('춘천','강원'),('충북혁신','대전/충청'),('충주교현','대전/충청'),('해운대','부산/울산'),('홍성','대전/충청');
...
INSERT INTO `user` VALUES ('lkj11150','$2b$10$Y1.lD37BL1Orkw1991VOye5YQJ59q9RWCUNkflg0FcreDoEDp6ei2','이운호','1998-09-28','01095331150','USER');
...
-- Dump completed on 2024-07-05 18:49:08
